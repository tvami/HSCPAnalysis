...
config.General.requestName = 'PrivateHSCP_2017_Gluino_Mass1800_DIGI2RECO_NoPU_IncThres_v1' #can be anything

config.section_('JobType')
config.JobType.allowUndistributedCMSSW = True
#config.JobType.pluginName = 'PrivateMC'
config.JobType.pluginName = 'Analysis'
config.JobType.psetName = '2-3HSCP_Gluino_Mass1800_DIGI_DIGI2RAW_RAW2DIGI_L1_RECO_trackingOnly_IncThres.py'
...
config.Data.inputDataset = '/HSCPgluino_M_1800/tvami-HSCP_Gluino_Mass1800_GENSIM-542b9c086283cdf48730c10aff03c7a7/USER'
