...
config.General.requestName = 'PrivateHSCP_2017_Gluino_Mass1800_DIGI2RECO_NoPU_v1' #can be anything

config.section_('JobType')
config.JobType.allowUndistributedCMSSW = True
#config.JobType.pluginName = 'PrivateMC'
config.JobType.pluginName = 'Analysis'
config.JobType.psetName = '2-3HSCP_Gluino_Mass1800_DIGI_DIGI2RAW_RAW2DIGI_L1_RECO_trackingOnly.py'
