...
//  v10.22 - Increase minimum signal size for error calculation to avoid low q fit issues
...
//!
//!  The resulting template is then used by PixelTempReco1D() (a global function) which
