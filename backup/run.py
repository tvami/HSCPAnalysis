...
##    fileNames =  cms.untracked.vstring('file:/scratch/dkotlins/digis.root')
   #fileNames =  cms.untracked.vstring(
    #'file:/afs/cern.ch/work/t/tvami/public/HSCP/HSCP/CMSSW_10_6_1_patch1/src/0RECOChain/HSCPSingalNoPU/4HSCP_Gluino_Mass800BasedpixelTreeWithSimInfo.root'
   #)
#)
...
process.GlobalTag = GlobalTag(process.GlobalTag, '94X_dataRun2_v9', '')
...
# read rechits
process.analysis = cms.EDAnalyzer("HSCPAnalyzer",
